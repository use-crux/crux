...
use crate::static_compiler::core::facts::{
    NativeStaticDefinition, NativeStaticProjectSourceRef, NativeStaticRelation,
};
use crate::static_compiler::lint::helpers::{has_items, is_record, metadata_path, metadata_value};
