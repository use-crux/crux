...
use crate::static_compiler::core::definition_merge::merge_definitions_by_id;
use crate::static_compiler::core::facts::NativeStaticIndexPatchFacts;
...
use crate::static_compiler::lint::findings::append_builtin_lint_findings;
use crate::static_compiler::relation::model::{
    NativeStaticRelationPolicyTable, resolve_native_static_relation_model,
};
use crate::static_compiler::source::model::with_native_static_source_model;
