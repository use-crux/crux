...
use crate::{
    ...
    static_compiler::analyze_parse::{
        ParsedAnalyzeFile, parsed_analyze_file, primary_analyze_files,
    },
    static_compiler::scoped_definitions::{ScopedDefinition, scoped_definitions_by_variable},
    static_compiler::source_groups::grouped_source_facts,
    static_compiler::tree_paths::grouped_tree_path_definition_facts,
};
