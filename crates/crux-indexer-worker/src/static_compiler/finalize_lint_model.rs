...
use crate::static_compiler::definition_merge::merge_definitions_by_id;
use crate::static_compiler::facts::NativeStaticIndexPatchFacts;
use crate::static_compiler::finalize::{append_missing_builtin_rule_descriptors, merge_fact_value};
use crate::static_compiler::lint_filter::NativeStaticLintOptions;
use crate::static_compiler::lints::append_builtin_lint_findings;
use crate::static_compiler::relations::{
    NativeStaticRelationPolicyTable, resolve_native_static_relation_model,
};
use crate::static_compiler::source_model::with_native_static_source_model;
