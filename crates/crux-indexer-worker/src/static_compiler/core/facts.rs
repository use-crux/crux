...
pub(crate) enum NativeStaticFidelity {
    Resolved,
    Partial,
    Error,
}
...
impl NativeStaticFidelity {
    ...
    pub(crate) fn relation_rank(self) -> u8 {
        match self {
            Self::Resolved => 2,
            Self::Partial => 1,
            Self::Error => 0,
...
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticSourceLocation {
    pub file: String,
    pub line: usize,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticDefinition {
    pub id: String,
    pub kind: String,
    pub name: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticRelationRef {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticRelation {
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: String,
    pub from: String,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticSourceRefFact {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticProjectSourceRef {
    pub id: String,
    pub role: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticDiagnostic {
    pub id: String,
...
pub(crate) enum NativeStaticDiagnosticSeverity {
    Info,
    Warning,
    Error,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticLintFinding {
    pub id: String,
    pub severity: NativeStaticDiagnosticSeverity,
    pub rule_id: String,
    pub title: String,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticRuleDescriptor {
    pub id: String,
    pub source: String,
    pub title: String,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticIndexSourceFile {
    pub file: String,
    pub status: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticSourceGraph {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct NativeStaticProjectIndexShard {
    pub id: String,
    pub root: String,
    #[serde(skip_serializing_if = "Option::is_none")]
