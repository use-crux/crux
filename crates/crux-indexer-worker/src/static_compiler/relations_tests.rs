...
use crate::static_compiler::relation_policy::NativeStaticRelationPolicy;
...
fn relation_identity_and_merge_match_project_index_contract() {
    ...
    first.source = Some(crate::static_compiler::facts::NativeStaticSourceLocation {
    ...
    second.source = Some(crate::static_compiler::facts::NativeStaticSourceLocation {
