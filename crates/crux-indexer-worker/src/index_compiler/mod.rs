...
//!
//! This module owns the Rust compiler stages that turn static syntax evidence
//! and first-party extractor facts into Project Index-compatible patch events.
//! JSON-lines transport code calls the facade instead of reaching into compiler
//! internals.
