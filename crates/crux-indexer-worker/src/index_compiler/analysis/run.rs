...
use crate::{
    extractors::projection::project_native_facts_with_records,
    index_compiler::analysis::parse::{
        ParsedAnalyzeFile, parsed_analyze_file, primary_analyze_files,
    },
    index_compiler::core::facts::NativeStaticIndexPatchFacts,
    index_compiler::core::scoped_definitions::{ScopedDefinition, scoped_definitions_by_variable},
    index_compiler::source::groups::grouped_source_facts,
    index_compiler::source::tree_paths::grouped_tree_path_definition_facts,
