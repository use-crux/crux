...
use crate::{
    ...
    extractors::injection::tools::{
        identifier_refs_for_property, tool_contributions_for_return_object_property,
    },
    extractors::record_values::{direct_string_property, property_value, resolve_static_value},
    extractors::routing::output::extracted_facts,
    extractors::schema::schema_property,
    extractors::source_refs::helper_refs_for_property,
...
struct InjectableContributions {
    use_entries: Vec<crate::extractors::injection::model::UseEntry>,
