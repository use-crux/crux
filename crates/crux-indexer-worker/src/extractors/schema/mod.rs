...
use crate::{
    ...
    extractors::record_values::property_value,
    extractors::schema::common::{child_values, contains_root_namespace},
    extractors::schema::convex::convex_value_to_json_schema,
    extractors::schema::zod::zod_value_to_json_schema,
    extractors::source_refs::schema_source_ref,
