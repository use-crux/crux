...
use crate::{
    extractors::projection::project_native_facts,
    protocol::{
...
///
/// New index compiler flows should call `syntax::frontend::parse_source`
/// first and run extractor projection explicitly through `index_compiler`.
