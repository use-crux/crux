...
use crate::{
    ...
    primitives::injection_tools::tool_contributions_for_property,
    primitives::record_values::{direct_string_property, has_property},
    primitives::routing_model::{CallParts, RoutingContext, source_ref_for_callback_property},
...
pub(crate) fn context_facts(context: &RoutingContext<'_>, parts: &CallParts<'_>) -> Option<Value> {
