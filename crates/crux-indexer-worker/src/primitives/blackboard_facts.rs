...
use crate::{
    ...
    primitives::memory_id::authored_memory_id,
    primitives::memory_store::{authored_store, authored_store_name, store_definition, store_id},
...
pub(crate) fn blackboard_facts(
    ...
    let id = format!(
        "blackboard:{}",
        crate::primitives::definition::safe_id(&definition_key)
    );
...
fn blackboard_fact_metadata(
    store: Option<&crate::primitives::memory_store::StoreInfo>,
