...
export type ImagePromptContent =
  | Readonly<{ text: string; images?: readonly [Asset, ...Asset[]]; mask?: never }>
  | Readonly<{ text: string; images: readonly [Asset, ...Asset[]]; mask: Asset }>
...
> = GenerateImageCommonOptions & ImageDimensions & PromptInputOption<TPrompt> & {
...
export type GenerateImageResult<TRaw = unknown, TProviderMetadata = unknown, TWarning = unknown> =
  CompletedOperationResult<TRaw, TProviderMetadata, TWarning> & Readonly<{
...
export type NativeGeneratedImage = Asset | Readonly<{
