/**
 *
 * Canonical JSON and identity helpers for Eval execution.
 *
 * Case identity and evidence fingerprints hash canonical JSON. Object keys
 * are sorted recursively and non-plain identity values are tagged
