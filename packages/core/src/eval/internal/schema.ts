 ...
 *
 * Vendored type-only copy of the community spec so Eval Case files accept
 * any conforming validation library —
 ...
 * Eval APIs use it where source types do not exist (for example Case files).
