/**
 * Skill index — generates the system prompt section listing available skills.
 */

import type { Skill } from './types'

/**
 * Generate the index system prompt text for a set of skills.
 * This is injected into the system prompt when >=1 skill is in the use array.
 */
export function generateIndex(skills: readonly Skill[]): string {
