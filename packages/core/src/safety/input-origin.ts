/** Semantic sources supported by {@link boundary.input.text}. */
export type TextInputSource = 'user' | 'tool' | 'retrieval'

/** Semantic sources supported by {@link boundary.input.media}. */
...
export type InputSourcesFromOptions<TOptions, TFallback extends InputSource> = TOptions extends {
...
export type ModelInputOriginFor<TSource extends InputSource> = Extract<ModelInputOrigin, { readonly source: TSource }>
