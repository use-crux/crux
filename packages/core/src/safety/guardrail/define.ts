...
import { mediaClassifier } from './strategies/media-classifier'
...
interface GuardrailFactory {
  ...
  /** Classify canonical input or output media through a structured generator. */
  readonly mediaClassifier: typeof mediaClassifier
}
