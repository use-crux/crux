...
import { evaluate, target, scorers } from '../../src/quality'
...
export const promptEval0 = evaluate('fixture.prompt.0', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful0', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
...
export const promptEval1 = evaluate('fixture.prompt.1', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful1', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval2 = evaluate('fixture.prompt.2', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful2', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval3 = evaluate('fixture.prompt.3', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful3', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval4 = evaluate('fixture.prompt.4', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful4', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval5 = evaluate('fixture.prompt.5', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful5', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval6 = evaluate('fixture.prompt.6', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful6', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval7 = evaluate('fixture.prompt.7', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful7', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval8 = evaluate('fixture.prompt.8', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful8', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval9 = evaluate('fixture.prompt.9', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful9', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval10 = evaluate('fixture.prompt.10', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful10', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval11 = evaluate('fixture.prompt.11', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful11', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval12 = evaluate('fixture.prompt.12', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful12', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval13 = evaluate('fixture.prompt.13', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful13', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval14 = evaluate('fixture.prompt.14', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful14', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval15 = evaluate('fixture.prompt.15', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful15', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval16 = evaluate('fixture.prompt.16', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful16', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval17 = evaluate('fixture.prompt.17', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful17', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval18 = evaluate('fixture.prompt.18', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful18', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
...
export const promptEval19 = evaluate('fixture.prompt.19', {
  ...
  scorers: (s: any) => [s.judge({ name: 'helpful19', rubric: 'Helpful?', select: (o: any) => o.answer }), s.exact()],
  variants: { cheap: { model: 'mini' }, hot: { settings: { temperature: 0.9 } } },
  baseline: 'cheap',
