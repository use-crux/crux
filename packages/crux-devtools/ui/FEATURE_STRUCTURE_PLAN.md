...
Goal: migrate `packages/crux-devtools/ui/src` to a durable
...
- Scope the feature-folder refactor to `packages/crux-devtools/ui`.
...
packages/crux-devtools/tsconfig.json --noEmit --pretty false`, and it passes.
