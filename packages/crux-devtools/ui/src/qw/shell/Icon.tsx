...
const PATHS: Record<IconName, string> = {
  ...
  brain: 'M9 4a3 3 0 00-3 3 3 3 0 00-2 5 3 3 0 002 5 3 3 0 003 3h6a3 3 0 003-3 3 3 0 002-5 3 3 0 00-2-5 3 3 0 00-3-3H9zm0 0v16',
...
export function Icon({ name, size = 14, color, strokeWidth = 1.6, className }: IconProps) {
  const d = PATHS[name]
  if (!d) return null
  return (
    <svg
