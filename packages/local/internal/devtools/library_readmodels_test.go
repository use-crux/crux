...
func TestWorkspaceDetailUsesPathHashAndArtifactMetadataFromObservedActivity(t *testing.T) {
	...
	if err := json.Unmarshal([]byte(`{
		"records": [
			{"schemaVersion":2,"recordId":"rec_write","type":"span","runId":"run_ws","segmentId":"run_ws_seg","segmentSeq":1,"traceId":"trace_ws","spanId":"span_write","family":"workspace","primitive":"workspace.operation","name":"workspace.write","startedAt":"2026-06-30T10:00:00.000Z","endedAt":"2026-06-30T10:00:00.012Z","durationMs":12,"status":"ok","attributes":{"workspaceId":"drafts","operation":"write","pathHash":"fnv1a:aaa111","namespaceHash":"ns1","mimeType":"text/markdown","size":42,"artifactStatus":"draft","artifactKind":"report"}},
			{"schemaVersion":2,"recordId":"rec_finalize","type":"span","runId":"run_ws","segmentId":"run_ws_seg","segmentSeq":2,"traceId":"trace_ws","spanId":"span_finalize","family":"workspace","primitive":"workspace.operation","name":"workspace.finalize","startedAt":"2026-06-30T10:00:01.000Z","endedAt":"2026-06-30T10:00:01.009Z","durationMs":9,"status":"ok","attributes":{"workspaceId":"drafts","operation":"finalize","pathHash":"fnv1a:bbb222","namespaceHash":"ns1","mimeType":"application/pdf","size":9001,"artifactStatus":"final","artifactKind":"report","uri":"workspace-inline://drafts/ns1/outputs/report.pdf"}},
			{"schemaVersion":2,"recordId":"artifact_finalize","type":"artifact","runId":"run_ws","segmentId":"run_ws_seg","segmentSeq":3,"traceId":"trace_ws","artifactId":"artifact_report","spanId":"span_finalize","kind":"output","createdAt":"2026-06-30T10:00:01.009Z","contentType":"application/json","encoding":"json","sizeBytes":9001,"uri":"workspace-inline://drafts/ns1/outputs/report.pdf","preview":{"contentStored":false},"attributes":{"workspaceId":"drafts","operation":"finalize","pathHash":"fnv1a:bbb222","artifactStatus":"final","artifactKind":"report","mimeType":"application/pdf","size":9001,"uri":"workspace-inline://drafts/ns1/outputs/report.pdf"}}
		]
	}`), &batch); err != nil {
		t.Fatal(err)
	}
...
func TestWorkspaceDetailMovesRenamedFilesFromObservedActivity(t *testing.T) {
	...
	if err := json.Unmarshal([]byte(`{
		"records": [
			...
			{"schemaVersion":2,"recordId":"artifact_write","type":"artifact","runId":"run_ws","segmentId":"run_ws_seg","segmentSeq":2,"traceId":"trace_ws","artifactId":"artifact_write","spanId":"span_write","kind":"output","createdAt":"2026-06-30T10:00:00.012Z","contentType":"application/json","encoding":"json","sizeBytes":42,"preview":{"resultKind":"file","path":"/workspace/old.md","mimeType":"text/markdown","size":42,"storage":"inline"},"attributes":{"workspaceId":"drafts","operation":"write","pathHash":"fnv1a:old111","mimeType":"text/markdown","size":42}},
			{"schemaVersion":2,"recordId":"rec_rename","type":"span","runId":"run_ws","segmentId":"run_ws_seg","segmentSeq":3,"traceId":"trace_ws","spanId":"span_rename","family":"workspace","primitive":"workspace.operation","name":"workspace.rename","startedAt":"2026-06-30T10:00:01.000Z","endedAt":"2026-06-30T10:00:01.009Z","durationMs":9,"status":"ok","attributes":{"workspaceId":"drafts","operation":"rename","pathHash":"fnv1a:old111","namespaceHash":"ns1","mimeType":"text/markdown","size":42}},
			{"schemaVersion":2,"recordId":"artifact_rename","type":"artifact","runId":"run_ws","segmentId":"run_ws_seg","segmentSeq":4,"traceId":"trace_ws","artifactId":"artifact_rename","spanId":"span_rename","kind":"output","createdAt":"2026-06-30T10:00:01.009Z","contentType":"application/json","encoding":"json","sizeBytes":42,"preview":{"resultKind":"file","path":"/workspace/new.md","mimeType":"text/markdown","size":42,"storage":"inline"},"attributes":{"workspaceId":"drafts","operation":"rename","pathHash":"fnv1a:old111","mimeType":"text/markdown","size":42}}
		]
	}`), &batch); err != nil {
		t.Fatal(err)
	}
...
func TestPlanDetailProjectsObservedTaskActivity(t *testing.T) {
	...
	if err := json.Unmarshal([]byte(`{
		"records": [
			{"schemaVersion":2,"recordId":"rec_plan_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":1,"traceId":"trace_tasks","spanId":"span_plan","family":"plan","primitive":"plan.operation","name":"plan.create","startedAt":"2026-05-21T10:00:00.000Z","endedAt":"2026-05-21T10:00:00.010Z","durationMs":10,"status":"ok","attributes":{"operation":"create","planId":"plan_tasks","title":"Task plan"}},
			{"schemaVersion":2,"recordId":"rec_plan_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":2,"traceId":"trace_tasks","artifactId":"artifact_plan","spanId":"span_plan","kind":"output","createdAt":"2026-05-21T10:00:00.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"plan.operation","operation":"create","planId":"plan_tasks","title":"Task plan","version":1,"content":"Plan body"}},

			{"schemaVersion":2,"recordId":"rec_list_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":3,"traceId":"trace_tasks","spanId":"span_list","family":"task","primitive":"task.operation","name":"tasklist.create","startedAt":"2026-05-21T10:00:01.000Z","endedAt":"2026-05-21T10:00:01.010Z","durationMs":10,"status":"ok","attributes":{"operation":"tasklist.create","taskListId":"list_1","planId":"plan_tasks"}},
			{"schemaVersion":2,"recordId":"rec_list_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":4,"traceId":"trace_tasks","artifactId":"artifact_list","spanId":"span_list","kind":"output","createdAt":"2026-05-21T10:00:01.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"tasklist.create","taskListId":"list_1","planId":"plan_tasks","status":"in_progress"}},

			{"schemaVersion":2,"recordId":"rec_add_completed_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":5,"traceId":"trace_tasks","spanId":"span_add_completed","family":"task","primitive":"task.operation","name":"task.add","startedAt":"2026-05-21T10:00:02.000Z","endedAt":"2026-05-21T10:00:02.010Z","durationMs":10,"status":"ok","attributes":{"operation":"add","taskListId":"list_1","taskId":"completed_task"}},
			{"schemaVersion":2,"recordId":"rec_add_completed_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":6,"traceId":"trace_tasks","artifactId":"artifact_add_completed","spanId":"span_add_completed","kind":"output","createdAt":"2026-05-21T10:00:02.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"add","taskListId":"list_1","taskId":"completed_task","label":"Completed task","status":"pending"}},
			{"schemaVersion":2,"recordId":"rec_update_completed_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":7,"traceId":"trace_tasks","spanId":"span_update_completed","family":"task","primitive":"task.operation","name":"task.update","startedAt":"2026-05-21T10:00:03.000Z","endedAt":"2026-05-21T10:00:03.010Z","durationMs":10,"status":"ok","attributes":{"operation":"update","taskListId":"list_1","taskId":"completed_task","status":"completed"}},
			{"schemaVersion":2,"recordId":"rec_update_completed_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":8,"traceId":"trace_tasks","artifactId":"artifact_update_completed","spanId":"span_update_completed","kind":"output","createdAt":"2026-05-21T10:00:03.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"update","taskListId":"list_1","taskId":"completed_task","label":"Completed task","status":"completed","durationMs":42}},

			{"schemaVersion":2,"recordId":"rec_update_failed_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":9,"traceId":"trace_tasks","spanId":"span_update_failed","family":"task","primitive":"task.operation","name":"task.update","startedAt":"2026-05-21T10:00:04.000Z","endedAt":"2026-05-21T10:00:04.010Z","durationMs":10,"status":"ok","attributes":{"operation":"update","taskListId":"list_1","taskId":"failed_task","status":"failed"}},
			{"schemaVersion":2,"recordId":"rec_update_failed_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":10,"traceId":"trace_tasks","artifactId":"artifact_update_failed","spanId":"span_update_failed","kind":"output","createdAt":"2026-05-21T10:00:04.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"update","taskListId":"list_1","taskId":"failed_task","label":"Failed task","status":"failed","progress":"Errored while drafting"}},

			{"schemaVersion":2,"recordId":"rec_update_skipped_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":11,"traceId":"trace_tasks","spanId":"span_update_skipped","family":"task","primitive":"task.operation","name":"task.update","startedAt":"2026-05-21T10:00:05.000Z","endedAt":"2026-05-21T10:00:05.010Z","durationMs":10,"status":"ok","attributes":{"operation":"update","taskListId":"list_1","taskId":"skipped_task","status":"skipped"}},
			{"schemaVersion":2,"recordId":"rec_update_skipped_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":12,"traceId":"trace_tasks","artifactId":"artifact_update_skipped","spanId":"span_update_skipped","kind":"output","createdAt":"2026-05-21T10:00:05.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"update","taskListId":"list_1","taskId":"skipped_task","label":"Skipped task","status":"skipped"}},

			{"schemaVersion":2,"recordId":"rec_update_cancelled_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":13,"traceId":"trace_tasks","spanId":"span_update_cancelled","family":"task","primitive":"task.operation","name":"task.update","startedAt":"2026-05-21T10:00:06.000Z","endedAt":"2026-05-21T10:00:06.010Z","durationMs":10,"status":"ok","attributes":{"operation":"update","taskListId":"list_1","taskId":"cancelled_task","status":"cancelled"}},
			{"schemaVersion":2,"recordId":"rec_update_cancelled_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":14,"traceId":"trace_tasks","artifactId":"artifact_update_cancelled","spanId":"span_update_cancelled","kind":"output","createdAt":"2026-05-21T10:00:06.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"update","taskListId":"list_1","taskId":"cancelled_task","label":"Cancelled task","status":"cancelled"}},

			{"schemaVersion":2,"recordId":"rec_add_removed_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":15,"traceId":"trace_tasks","spanId":"span_add_removed","family":"task","primitive":"task.operation","name":"task.add","startedAt":"2026-05-21T10:00:07.000Z","endedAt":"2026-05-21T10:00:07.010Z","durationMs":10,"status":"ok","attributes":{"operation":"add","taskListId":"list_1","taskId":"removed_task"}},
			{"schemaVersion":2,"recordId":"rec_add_removed_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":16,"traceId":"trace_tasks","artifactId":"artifact_add_removed","spanId":"span_add_removed","kind":"output","createdAt":"2026-05-21T10:00:07.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"add","taskListId":"list_1","taskId":"removed_task","label":"Removed task","status":"pending"}},
			{"schemaVersion":2,"recordId":"rec_remove_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":17,"traceId":"trace_tasks","spanId":"span_remove","family":"task","primitive":"task.operation","name":"task.remove","startedAt":"2026-05-21T10:00:08.000Z","endedAt":"2026-05-21T10:00:08.010Z","durationMs":10,"status":"ok","attributes":{"operation":"remove","taskListId":"list_1","taskId":"removed_task"}},
			{"schemaVersion":2,"recordId":"rec_remove_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":18,"traceId":"trace_tasks","artifactId":"artifact_remove","spanId":"span_remove","kind":"output","createdAt":"2026-05-21T10:00:08.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"remove","taskListId":"list_1","taskId":"removed_task","label":"Removed task","status":"cancelled"}},

			{"schemaVersion":2,"recordId":"rec_discard_span","type":"span","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":19,"traceId":"trace_tasks","spanId":"span_discard","family":"task","primitive":"task.operation","name":"tasklist.discard","startedAt":"2026-05-21T10:00:09.000Z","endedAt":"2026-05-21T10:00:09.010Z","durationMs":10,"status":"ok","attributes":{"operation":"tasklist.discard","taskListId":"list_1","planId":"plan_tasks"}},
			{"schemaVersion":2,"recordId":"rec_discard_artifact","type":"artifact","runId":"run_tasks","segmentId":"run_tasks_seg","segmentSeq":20,"traceId":"trace_tasks","artifactId":"artifact_discard","spanId":"span_discard","kind":"output","createdAt":"2026-05-21T10:00:09.010Z","contentType":"application/json","encoding":"json","preview":{"primitive":"task.operation","operation":"tasklist.discard","taskListId":"list_1","planId":"plan_tasks","status":"discarded"}}
		]
	}`), &batch); err != nil {
		t.Fatal(err)
	}
