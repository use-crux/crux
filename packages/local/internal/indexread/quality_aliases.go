...
type qualityFeedbackRecord = qualityfs.Feedback
type qualityFeedbackAnnotationRecord = qualityfs.FeedbackAnnotation
type qualityCassetteSummary = qualityfs.Cassette
type qualityCassetteBoundary = qualityfs.CassetteBoundary
type qualityCassetteEntrySummary = qualityfs.CassetteEntry
type qualityCassetteIssueRecord = qualityfs.CassetteIssue
