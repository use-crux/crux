package projectindexwire_test

import (
	"encoding/json"
	"testing"

	"github.com/use-crux/crux/packages/local/internal/projectindexwire"
)

func TestPatchStreamCollectorDecodesContractFixtureEvents(t *testing.T) {
	collector := projectindexwire.NewProjectIndexPatchStreamCollector(projectindexwire.ProjectIndexPatchStreamOptions{
		Root:             "/repo",
