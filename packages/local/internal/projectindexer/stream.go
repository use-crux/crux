...
func (w *Worker) sourceOnlyArtifactFallback(ctx context.Context, req projectIndexRequest, artifact devtools.ProjectIndexArtifactKind, cause error) (json.RawMessage, error) {
...
func (w *Worker) streamPatches(ctx context.Context, req projectIndexRequest, budget devtools.IndexPatchBudget) ([]devtools.IndexPatch, error) {
...
func (w *Worker) streamCollector(ctx context.Context, req projectIndexRequest, budget devtools.IndexPatchBudget) (*devtools.ProjectIndexPatchStreamCollector, error) {
...
func (w *Worker) streamArtifact(ctx context.Context, req projectIndexRequest, artifact devtools.ProjectIndexArtifactKind) (json.RawMessage, error) {
...
func (w *Worker) streamRequest(ctx context.Context, req projectIndexRequest, handle func(json.RawMessage) error) (nodeworker.StreamResult, error) {
	...
	return nodeworker.Stream(ctx, nodeworker.OneShot{
		Script: nodeworker.Script{
			...
			Content: w.scriptContent,
		},
		ScriptPath:   w.scriptPath,
		Input:        data,
		MaxLineBytes: workerMaxResponseBytes,
	}, handle)
}

func (w *Worker) streamPatchRequest(ctx context.Context, req projectIndexRequest, handle func(json.RawMessage) error, done func() bool) error {
	req.ProtocolVersion = 2
	requests, err := requestBatch(req)
	if err != nil {
		return err
	}
...
func requestBatch(req projectIndexRequest) ([]any, error) {
...
func startRequest(req projectIndexRequest, requestID string) projectIndexRequest {
	start := req
