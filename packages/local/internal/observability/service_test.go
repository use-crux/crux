...
func TestServiceReadsRunGraphAndDetailByTraceID(t *testing.T) {
	...
	batch := mustBatch(t,
		...
		`{"schemaVersion":2,"recordId":"rec_agent","type":"span:start","runId":"run_trace_alias","segmentId":"seg_trace_alias_a","segmentSeq":2,"traceId":"trace_trace_alias","spanId":"span_agent","family":"agent","primitive":"agent.run","name":"Karyla streamText","startedAt":"2026-05-16T18:00:00.010Z","status":"running"}`,
...
func TestServiceRunsRollUpSpanMetricsAndIdentity(t *testing.T) {
	...
	batch := mustBatch(t,
		...
		`{"schemaVersion":2,"recordId":"rec_generate","type":"span","runId":"run_list_rollup","segmentId":"seg_list_rollup_a","segmentSeq":2,"traceId":"trace_list_rollup","spanId":"span_generate","family":"generation","primitive":"generation.stream","name":"stream Karyla","startedAt":"2026-05-16T18:00:00.010Z","endedAt":"2026-05-16T18:00:01.010Z","durationMs":1000,"status":"ok","attributes":{"model":"google/gemini-3.1-flash-lite-preview","provider":"openrouter","promptId":"chat.answer"},"metrics":{"inputTokens":10,"outputTokens":12,"totalTokens":22,"costUsd":0.02}}`,
...
func TestServiceRetainsOutOfOrderChildSpansUntilParentArrives(t *testing.T) {
	...
	parentLater := mustBatch(t,
		`{"schemaVersion":2,"recordId":"rec_parent_start","type":"span:start","runId":"run_out_of_order","segmentId":"seg_out_of_order_a","segmentSeq":4,"traceId":"trace_out_of_order","spanId":"span_parent","family":"agent","primitive":"agent.run","name":"Karyla","startedAt":"2026-05-16T18:00:00.010Z","status":"running"}`,
...
func TestServiceRunDetailBuffersSiblingDetailsOntoNextPrimarySpan(t *testing.T) {
	...
	batch := mustBatch(t,
		...
		`{"schemaVersion":2,"recordId":"rec_generate","type":"span","runId":"run_generation_view","segmentId":"seg_generation_view_a","segmentSeq":5,"traceId":"trace_generation_view","spanId":"span_generate","parentSpanId":"span_agent","family":"generation","primitive":"generation.call","name":"generate karyla-agent","startedAt":"2026-05-16T18:00:00.020Z","endedAt":"2026-05-16T18:00:01.020Z","durationMs":1000,"status":"ok","model":"gpt-4o","provider":"openai"}`,
...
func TestServiceRunDetailReconcilesMissingParentEndsFromTerminalChildren(t *testing.T) {
	...
	batch := mustBatch(t,
		...
		`{"schemaVersion":2,"recordId":"rec_generate","type":"span","runId":"run_parent_reconcile","segmentId":"seg_parent_reconcile_a","segmentSeq":3,"traceId":"trace_parent_reconcile","spanId":"span_generate","parentSpanId":"span_chat","family":"generation","primitive":"generation.stream","name":"stream Karyla","startedAt":"2026-05-16T18:00:00.002Z","endedAt":"2026-05-16T18:00:00.100Z","durationMs":98,"status":"ok"}`,
