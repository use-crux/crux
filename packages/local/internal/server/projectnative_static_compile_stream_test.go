...
func TestProjectIndexWorkerNativeStaticCompilerUsesCompileStreamWhenNativeOnly(t *testing.T) {
	root := t.TempDir()
...
var _ projectNativeStaticCompileStreamer = (*nativeStaticCompileCutoverCompiler)(nil)
