...
func TestDevServer_ingest_and_read(t *testing.T) {
	...
	body := `{"schemaVersion":4,"records":[
		{"schemaVersion":4,"recordId":"rec_run_start","type":"run:start","runId":"run-live","operationId":"run-live","segmentId":"seg-live","segmentSeq":1,"traceId":"trace-live","name":"live","rootPrimitive":"generation.call","startedAt":"2026-05-16T18:00:00.000Z","status":"running"},
		{"schemaVersion":4,"recordId":"rec_run_end","type":"run:end","runId":"run-live","operationId":"run-live","segmentId":"seg-live","segmentSeq":2,"traceId":"trace-live","endedAt":"2026-05-16T18:00:00.010Z","durationMs":10,"status":"ok"}
	]}`
