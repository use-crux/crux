...
func (w *ProjectIndexWorker) projectNativeStaticExtensionHostManifest(
	ctx context.Context,
	root string,
	configPath string,
...
func (w *ProjectIndexWorker) projectNativeStaticExtensionEvidenceFacts(
	ctx context.Context,
	root string,
	configPath string,
	projectName string,
...
func (w *ProjectIndexWorker) projectNativeStaticRuleFacts(
	ctx context.Context,
	root string,
	configPath string,
	projectName string,
