...
func TestProjectSyntaxWorkerPoolNativeStaticCompilerUsesCommandWorker(t *testing.T) {
	pool := NewProjectSyntaxWorkerPool(2, shellPath(t), fakeNativeStaticCompilerWorker(t))
	defer pool.Close()
...
var _ ProjectNativeStaticCompiler = (*ProjectSyntaxWorkerPool)(nil)
