...
func (w *ProjectIndexWorker) IndexProjectLintPatch(ctx context.Context, request devtools.ProjectLintIndexRequest) (devtools.IndexPatch, error) {
...
func (w *ProjectIndexWorker) PrefetchProjectLintFacts(
	ctx context.Context,
...
func (w *ProjectIndexWorker) projectNativeStaticRuleFactsFromPrefetchOrRequest(
	ctx context.Context,
	request devtools.ProjectLintIndexRequest,
...
func (w *ProjectIndexWorker) projectNativeStaticPostMergeRuleFacts(
	ctx context.Context,
	request devtools.ProjectLintIndexRequest,
) ([]json.RawMessage, error) {
