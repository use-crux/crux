...
func TestProjectIndexWorkerNativeStaticErrorsWhenFinalizeHasNoPatch(t *testing.T) {
...
func (c *nativeStaticNoPatchCompiler) ParseFile(context.Context, ProjectSyntaxParseRequest) (json.RawMessage, error) {
	return nil, fmt.Errorf("ParseFile should not be called by fallback test")
}

func (c *nativeStaticNoPatchCompiler) ParseFilesStream(_ context.Context, requests []ProjectSyntaxParseRequest, handle ProjectSyntaxRecordHandler) error {
	c.streamParseCalls++
...
var _ ProjectSyntaxParser = (*nativeStaticNoPatchCompiler)(nil)
var _ ProjectSyntaxBatchStreamParser = (*nativeStaticNoPatchCompiler)(nil)
var _ ProjectNativeStaticCompiler = (*nativeStaticNoPatchCompiler)(nil)
