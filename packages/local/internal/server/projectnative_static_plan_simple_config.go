...
func projectNativeStaticInspectSimpleConfig(
	root string,
	configPath string,
	...
	config, ok := projectNativeStaticParseSimpleConfig(root, configFile, string(source))
...
func projectNativeStaticParseSimpleConfig(
	root string,
	configFile string,
	source string,
