...
func TestProjectIndexWorkerPlanProjectSemanticRequestUsesNativeStaticSourceProfile(t *testing.T) {
	root := t.TempDir()
...
func TestProjectIndexWorkerSharesConcurrentStaticSyntaxPlan(t *testing.T) {
...
func waitForStaticSyntaxPlanWaiter(t testing.TB, worker *ProjectIndexWorker) {
	t.Helper()
...
type noopProjectSyntaxParser struct{}

func (noopProjectSyntaxParser) ParseFile(context.Context, ProjectSyntaxParseRequest) (json.RawMessage, error) {
	return json.RawMessage(`{}`), nil
}

func (noopProjectSyntaxParser) Concurrency() int { return 1 }

func (noopProjectSyntaxParser) Close() error { return nil }
