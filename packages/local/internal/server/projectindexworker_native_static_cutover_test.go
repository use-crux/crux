...
func TestProjectIndexWorkerNativeStaticCutoverUsesFinalizePatchEvents(t *testing.T) {
...
func (c *nativeStaticCutoverCompiler) ParseFile(context.Context, ProjectSyntaxParseRequest) (json.RawMessage, error) {
	c.parseCalls++
	return nil, fmt.Errorf("ParseFile should not be called by native static cutover")
}

func (c *nativeStaticCutoverCompiler) ParseFiles(context.Context, []ProjectSyntaxParseRequest) ([]json.RawMessage, error) {
	c.batchParseCalls++
	return nil, fmt.Errorf("ParseFiles should not be called by native static cutover")
}

func (c *nativeStaticCutoverCompiler) ParseFilesStream(context.Context, []ProjectSyntaxParseRequest, ProjectSyntaxRecordHandler) error {
	c.streamParseCalls++
...
var _ ProjectSyntaxParser = (*nativeStaticCutoverCompiler)(nil)
var _ ProjectSyntaxBatchParser = (*nativeStaticCutoverCompiler)(nil)
var _ ProjectSyntaxBatchStreamParser = (*nativeStaticCutoverCompiler)(nil)
var _ ProjectNativeStaticCompiler = (*nativeStaticCutoverCompiler)(nil)
