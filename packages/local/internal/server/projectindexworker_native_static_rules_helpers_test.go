...
func (c *nativeStaticRuleCompiler) ParseFile(context.Context, ProjectSyntaxParseRequest) (json.RawMessage, error) {
...
var _ ProjectSyntaxParser = (*nativeStaticRuleCompiler)(nil)
var _ ProjectNativeStaticCompiler = (*nativeStaticRuleCompiler)(nil)
