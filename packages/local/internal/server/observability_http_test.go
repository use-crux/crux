...
func TestObservabilityHTTPMapsInvalidAndMissing(t *testing.T) {
	...
	resp, err := http.Post(ts.URL+"/api/observability/records", "application/json", strings.NewReader(`{"schemaVersion":5,"records":[{"schemaVersion":5,"recordId":"rec_bad","type":"span","runId":"run_bad","operationId":"run_bad","segmentId":"run_bad_seg","segmentSeq":1,"spanId":"span_bad","family":"tool","primitive":"generation.call","name":"bad","startedAt":"2026-05-16T18:00:00.001Z","status":"ok"}]}`))
	if err != nil {
...
func TestObservabilityHTTPResourceActivity(t *testing.T) {
	...
	body := `{"schemaVersion":5,"records":[
		{"schemaVersion":5,"recordId":"rec_run_start","type":"run:start","runId":"run_resource","operationId":"run_resource","segmentId":"run_resource_seg","segmentSeq":1,"traceId":"trace_resource","name":"resource","rootPrimitive":"workspace.operation","startedAt":"2026-05-16T18:00:00.000Z","status":"running"},
		{"schemaVersion":5,"recordId":"rec_workspace","type":"span","runId":"run_resource","operationId":"run_resource","segmentId":"run_resource_seg","segmentSeq":2,"traceId":"trace_resource","spanId":"span_workspace","family":"workspace","primitive":"workspace.operation","name":"workspace.write","startedAt":"2026-05-16T18:00:00.001Z","endedAt":"2026-05-16T18:00:00.011Z","durationMs":10,"status":"ok","attributes":{"workspaceId":"drafts","operation":"write","path":"/output.md"}}
	]}`
...
func withObservabilityBatchSchemaVersion(t *testing.T, raw string) string {
	...
	return raw[:index] + `"schemaVersion":5,` + raw[index:]
}
