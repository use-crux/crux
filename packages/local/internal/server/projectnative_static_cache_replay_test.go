...
func TestProjectIndexWorkerNativeStaticReplaysWarmStaticCacheFacts(t *testing.T) {
	t.Setenv(projectIndexerNativeStaticCacheStatusEnv, "1")
...
func (c *nativeStaticCacheReplayCompiler) ParseFile(context.Context, ProjectSyntaxParseRequest) (json.RawMessage, error) {
...
var _ ProjectSyntaxParser = (*nativeStaticCacheReplayCompiler)(nil)
var _ ProjectNativeStaticCompiler = (*nativeStaticCacheReplayCompiler)(nil)
