...
func TestProjectIndexWorkerNativeStaticWritesWarmStaticCacheManifest(t *testing.T) {
...
func (c *nativeStaticCacheWriteCompiler) ParseFile(context.Context, ProjectSyntaxParseRequest) (json.RawMessage, error) {
...
var _ ProjectSyntaxParser = (*nativeStaticCacheWriteCompiler)(nil)
var _ ProjectNativeStaticCompiler = (*nativeStaticCacheWriteCompiler)(nil)
