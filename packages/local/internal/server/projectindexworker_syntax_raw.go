...
func projectIndexSyntaxRecordBatchRequestLine(method string, requestID string, records []json.RawMessage) nodeworker.RawJSONLine {
	...
	buffer.WriteString(`]}`)
	return nodeworker.RawJSONLine(buffer.Bytes())
}
