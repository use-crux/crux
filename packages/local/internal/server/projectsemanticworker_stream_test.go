...
func TestProjectSemanticWorker_streamsSemanticSourceProfileRequestBatches(t *testing.T) {
...
func TestProjectSemanticWorker_streamsPreviousIndexRequestBatches(t *testing.T) {
	if _, err := findNodePath(); err != nil {
		t.Skipf("node unavailable: %v", err)
	}
