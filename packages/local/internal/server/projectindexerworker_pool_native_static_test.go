...
func TestProjectIndexerWorkerPoolNativeStaticCompilerUsesCommandWorker(t *testing.T) {
	pool := NewProjectIndexerWorkerPool(2, shellPath(t), fakeNativeStaticCompilerWorker(t))
	defer pool.Close()
...
var _ ProjectNativeStaticCompiler = (*ProjectIndexerWorkerPool)(nil)
