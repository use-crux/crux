...
func registerQualityRunEventsHTTP(mux *http.ServeMux, hub *WSHub, qualityEvents *quality.EventBus) {
...
func publishRunEventActivity(qualityEvents *quality.EventBus, raw json.RawMessage) {
