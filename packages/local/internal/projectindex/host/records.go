...
func (w *Worker) indexProjectAstFromSyntaxRecordsPatch(ctx context.Context, root, configPath, projectName string, records []json.RawMessage, identity *projectindex.SyntaxFrontend, staticCacheHits []projectindex.StaticCacheHit) (projectindex.IndexPatch, error) {
