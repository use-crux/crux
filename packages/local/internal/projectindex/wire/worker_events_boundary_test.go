...
import (
	...
	"github.com/use-crux/crux/packages/local/internal/projectindex/wire"
)

func TestPatchStreamCollectorDecodesContractFixtureEvents(t *testing.T) {
	collector := wire.NewProjectIndexPatchStreamCollector(wire.ProjectIndexPatchStreamOptions{
		Root:             "/repo",
