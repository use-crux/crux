...
var cruxSignalPatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`\bknowledgeBase\s*\(`),
	regexp.MustCompile(`\brelate\s*\(`),
	regexp.MustCompile(`\brelateReferences\s*\(`),
	regexp.MustCompile(`\brelateEntities\s*\(`),
	regexp.MustCompile(`\bassertions\s*\(`),
	regexp.MustCompile(`\bcommunities\s*\(`),
	regexp.MustCompile(`\bknowledgeModel\s*\(`),
	regexp.MustCompile(`\b\w+\.view\s*\(`),
	regexp.MustCompile(`\bretrievalRecipe\s*\(`),
	regexp.MustCompile(`\bretrievalStep\s*\(`),
	regexp.MustCompile(`\brewriteQuery\s*\(`),
