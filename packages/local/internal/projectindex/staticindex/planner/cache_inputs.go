...
func DefaultCacheCompilerInputs() []json.RawMessage {
	...
	inputs := []string{
		...
		`{"kind":"extension-manifest","name":"@use-crux/indexer/crux-core","version":"1","digest":"9c3b36a0826e4861a68247126a241017715048d9fef28b6649808f17ace3ba71"}`,
		`{"kind":"extension","name":"@use-crux/indexer/crux-core","version":"1"}`,
