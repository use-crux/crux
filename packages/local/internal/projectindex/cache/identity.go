...
// that stale snapshot masking after restart could hide from crux dev. Epoch 38
// adds deployed Eval registry corroboration. Prior default Static Index scheduling,
// runtime owner facts, and all-kind extractor provenance remain included.
// TS-owned AST and semantic fact cache identity remain versioned in
// @use-crux/indexer.
const ProjectIndexSnapshotCacheEpoch = 38
