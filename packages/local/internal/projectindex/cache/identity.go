...
// that stale snapshot masking after restart could hide from crux dev. Epoch 40
// installs the canonical Eval vocabulary and removes the obsolete run overlay
// from persisted definitions while retaining default Static Index scheduling.
// TS-owned AST and semantic fact cache identity remain versioned in
// @use-crux/indexer.
const ProjectIndexSnapshotCacheEpoch = 40
