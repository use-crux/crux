...
// PromptTextLinks pins one current OWN/ATTACHED analyzer epoch while
// projecting identity-sensitive, eagerly validated Markdown links.
func (w *workspaceRuntime) PromptTextLinks(
	ctx context.Context,
	...
	empty := lsprompttext.LinkResult{
		Revision: document.Revision, Links: []protocol.DocumentLink{},
	}
	...
	defer cancel()
	result := w.server.promptText.Links(queryContext, lsprompttext.Request{
