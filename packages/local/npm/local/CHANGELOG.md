...
- 258ff0a: Restore scrolling in the Devtools Index definition detail pane.
...
- f5d69bf: Publish Linux and macOS `crux` and static-index worker binaries with executable
