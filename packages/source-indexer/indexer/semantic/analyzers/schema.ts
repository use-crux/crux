import type { JsonSchema, ProjectDefinition, ProjectSourceRef } from '@crux/core/catalog'
...
/**
 * Creates the analyzer that resolves schema expressions into catalog metadata and source refs.
 */
