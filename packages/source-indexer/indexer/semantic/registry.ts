import type { JsonSchema, ProjectDefinition, ProjectRelation, ProjectSourceRef } from '@crux/core/catalog'
...
/**
 * Builds the ordered analyzer registry used by `semanticCatalogFacts`.
 *
