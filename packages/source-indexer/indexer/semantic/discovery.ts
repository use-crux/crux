...
/**
 * Maps a known helper call to the catalog definition it authors.
 */
...
/**
 * Resolves the stable catalog name for memory-like authored resources.
 */
...
/**
 * Extracts the catalog-id prefix encoded by `createMemoryId(...)` calls.
 */
