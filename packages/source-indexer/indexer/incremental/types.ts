...
/**
 * Planner confidence in the previous catalog graph evidence.
 *
...
/**
 * Options for planning catalog work after file changes.
 */
...
/**
 * Decision to rebuild the complete Project Catalog.
 *
...
export interface FullReindexRequiredDecision {
  ...
  readonly previousCatalogDefinitionCount: number
  readonly explanation: IncrementalDecisionExplanation
}

/**
 * Decision describing a safe source-file-only catalog refresh.
 *
 ...
 *
 * This is planning-only. It is valid only when dependents in the previous catalog graph explain the
 * complete affected closure.
 */
