 ...
 * compiler boundary feed the current catalog relation resolver while downstream catalog projection is
 ...
 * only become useful to later phases without forcing placeholder catalog definitions into the current
