...
import type { ProjectSourceRef } from '@crux/core/catalog'
 ...
 * catalog data flow needs: step labels, target variables, callback source refs, and visible data access.
 */
 ...
 *
 * The returned value is deliberately catalog-facing and immutable. Raw TypeScript nodes stay inside
