...
import type { CatalogExtractor, ConfigReader } from '../extensions'
 ...
 */
export const ragRetrieverCatalogExtractor: CatalogExtractor = {
  name: 'rag.retriever',
  patterns: [
 ...
 *
 * The stage keeps only catalog-facing data: id/name/type/order/source target. Stage source has already
...
/**
 * Converts retrieval-pipeline stage config readers into folded catalog child definitions.
 *
