 ...
 * prompt callbacks/templates/helpers, and visible data-access relations without mutating catalog state.
 */
export const promptCatalogExtractor: CatalogExtractor = {
  name: 'prompt',
 ...
 * catalog relations. This keeps extraction pure and independent of graph state.
 */
