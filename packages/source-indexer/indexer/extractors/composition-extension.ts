...
import { facts, type CatalogExtractor, type ExtractContext, type StaticObjectReader } from '../extensions'
 ...
 *
 * The child carries both the catalog definition and optional relation target information so metadata,
 ...
 * structured control intelligence so catalog consumers can understand orchestration without parsing
 * source text.
 */
export const compositionCatalogExtractor: CatalogExtractor = {
  name: 'composition',
  patterns: [
...
/** Maps a composition factory call to its catalog definition kind. */
