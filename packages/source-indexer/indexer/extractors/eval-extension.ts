 ...
 * catalog lints can reason about quality coverage without executing eval code.
 */
export const evalCatalogExtractor: CatalogExtractor = {
  name: 'eval',
  patterns: [
...
/** Maps an eval factory name to the catalog definition kind it contributes. */
