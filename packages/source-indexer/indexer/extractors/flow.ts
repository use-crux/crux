...
/**
 * Projects a parser-owned `flow(...)` call into immutable catalog facts.
 *
 * The function owns catalog identity, folded step definitions, and relation refs. Source traversal for
 ...
 *
 * The metadata is intentionally catalog-facing: it describes execution mode, child ordering, and
