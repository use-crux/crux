...
Current: `--tui` opt-in flag at `packages/crux-cli/internal/commands/dev.go:236`.
...
```
packages/crux-cli/internal/tui/
...
- Scoped Go tests: `cd packages/crux-cli && go test ./internal/tui/... ./internal/api/...`
