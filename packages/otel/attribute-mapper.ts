...
export function metricsFor(metrics: Record<string, unknown> | undefined): OtelAttributes {
  if (!metrics) return {}
...
export function attributesFor(attributes: Record<string, unknown> | undefined): OtelAttributes {
...
function attributeKeyFor(key: string, workspaceAttributes = false): string | undefined {
