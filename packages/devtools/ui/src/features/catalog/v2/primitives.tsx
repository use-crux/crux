/**
 * Catalog v2 shell primitives — ported from the design's shared.jsx / v4-shell.jsx.
 *
 * Self-contained (Chip / Btn / Eyebrow / SectionHead) so the catalog reads
...
export function Chip({
  ...
  return (
    ...
    >
      {dot && (
        <span style={{ width: 5, height: 5, borderRadius: 99, background: c.fg, display: 'inline-block' }} />
      )}
      {children}
    </span>
  )
