...
export function ErrorGroupBar({ traces, onFilterErrors }: { traces: Trace[]; onFilterErrors?: () => void }) {
  ...
  return (
    <div className="flex items-center gap-3 bg-(--qw-danger-soft) border border-(--qw-danger-soft) rounded-lg px-3 py-1.5 text-xs">
      ...
      {groups.length > 1 && (
        <button onClick={onFilterErrors} className="text-[10px] text-zinc-500 hover:text-zinc-300 shrink-0 ml-auto">
