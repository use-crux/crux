            ...
            >
              ...
              {baseline && (
                <span className="text-zinc-500 font-normal ml-1.5">
                  / avg {formatTokens(baseline.avgTokens)}
                </span>
              )}
            </span>
          </div>
              ...
              <div key={part.source} className="px-3 py-2">
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="text-zinc-500 truncate line-through">
                      {part.source}
                    </span>
                    <span className="text-zinc-600 text-[10px]">skipped</span>
                  </div>
                  <span className="text-zinc-600 tabular-nums shrink-0 ml-3">
                    {part.tokens.toLocaleString()}
                  </span>
                </div>
              </div>
            ...
            <div className="px-3 py-2 space-y-1.5">
              ...
              {droppedContexts.map((ctx) => (
                ...
                >
                  ...
                  <span className="text-zinc-600 tabular-nums shrink-0 ml-3">
                    {ctx.tokens.toLocaleString()} tokens
                  </span>
                </div>
              ))}
            </div>
