    ...
    >
      <div className="px-8 pb-10 pt-5">
        ...
        <div className="mt-7">
          ...
          >
            Promotion gates aren't editable from the UI yet. They live in the comparison record and
            are evaluated when you promote a candidate; see the Compare screen for the gate panel.
          </div>
        </div>
      </div>
    </QwShell>
    ...
    <>
      ...
      <div className="flex flex-col gap-2.5">
        {list.length === 0 && (
            ...
            >
              No scorers yet. Scorer rows are derived from experiment case scores once you run a
              suite.
            </div>
          )}
          {list.map((s) => {
                ...
                <div>
                  <div className="text-[12.5px] leading-[1.5]" style={{ color: 'var(--qw-fg-muted)' }}>
                    ...
                    <span className="font-mono">
                      {s.suiteIds?.length ? s.suiteIds.join(', ') : '(no suites)'}
                    </span>
                  </div>
