...
const GRAPH_STRUCTURAL =
  /includes_step|includes_route|includes_tier|includes_option|includes_block|includes_case|uses_store|storage\.bundle\.uses_(record|vector|blob)_store|storage\.scope\.wraps_storage/
            ...
            {visNodes.map((n) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    style={{ fontFamily: T.mono, fontSize: 11, fontWeight: on ? 600 : 450, color: on ? c.fg : T.fg }}
                  >
                    {n.name}
                  </span>
                </div>
        ...
        {sel && (
          ...
          >
            ...
            >
              ...
              {sel.description && (
                <p
                  style={{ margin: '10px 0 0', fontFamily: T.serif, fontSize: 12.5, lineHeight: 1.5, color: T.fgMuted }}
                >
                  {sel.description}
                </p>
              )}
                      ...
                      {es.map((e, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span style={{ fontFamily: T.mono, fontSize: 9, color: T.fgFaint }}>
                              {e.type.replace(/_/g, ' ')}
                            </span>
                          </button>
                        )
