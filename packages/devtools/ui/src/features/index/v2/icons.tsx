 ...
 * set verbatim so the index reads pixel-identically to the handoff and
 * stays self-contained. `CatIcon` adds the index-specific glyphs (kind
...
export const ICONS: Record<string, string> = {
  ...
  sparkle: 'M12 3v4m0 10v4m9-9h-4M7 12H3m13.5-6.5l-2.5 2.5M10 14l-2.5 2.5m9 0L14 14m-4-4L7.5 7.5',
  ...
  cassette: 'M3 6h18v12H3zM7 12h10M7 10a2 2 0 100-4 2 2 0 000 4zm10 0a2 2 0 100-4 2 2 0 000 4z',
...
export const INDEX_ICONS: Record<string, string> = {
  ...
  gitcompare: 'M7 5a2 2 0 100 4 2 2 0 000-4zM7 9v6a2 2 0 002 2h4M17 19a2 2 0 100-4 2 2 0 000 4zm0-4V9a2 2 0 00-2-2h-4',
