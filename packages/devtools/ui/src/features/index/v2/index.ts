...
export { buildIndex, type IndexIndex, type ViewDef, type HealthFinding, type HealthRuleDescriptor } from './adapt'
...
export { IndexHealthList, IndexHealthOverview, IndexHealthSection } from './health'
export { storageInventoryForIndex, storageSummaryForDef, storageWarningsForDef } from './storage'
export type { StorageInventoryItem, StorageReadModelSummary, StorageWarningSummary } from './storage'
