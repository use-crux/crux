...
export type ProjectDefinitionFacts =
  ...
  | ({ kind: string; extensions?: Record<string, unknown> } & Record<
      string,
      unknown
    >);
...
export interface RetrievalStageEndEvent extends Omit<
...
export type RetrievalStageEventData = (
  | RetrievalStageStartEvent
...
export type IngestEventData =
  | (IngestParseStartEvent & { _kind: "start" })
  | (IngestParseEndEvent & { _kind: "end" });
