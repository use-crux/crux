...
> = {
  ...
  iris: {
    bg: "var(--qw-iris-soft)",
    fg: "var(--qw-iris)",
    ring: "var(--qw-iris-soft)",
    dot: "var(--qw-iris)",
  },
  gold: {
    bg: "var(--qw-gold-soft)",
    fg: "var(--qw-gold)",
    ring: "var(--qw-gold-line)",
    dot: "var(--qw-gold)",
  },
  plum: {
    bg: "var(--qw-plum-soft)",
    fg: "var(--qw-plum)",
    ring: "var(--qw-plum-line)",
    dot: "var(--qw-plum)",
  },
};
...
export function CruxMark({ size = 18 }: { size?: number }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <span style={{ fontSize: size * 0.65, color: "var(--qw-fg-faint)" }}>
        devtools
      </span>
    </div>
  );
