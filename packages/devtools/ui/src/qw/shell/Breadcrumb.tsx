 ...
 * (see `QwShellProps.breadcrumb`). This component splits that string and
          ...
          <Fragment key={i}>
            ...
            {target ? (
              <button
                ...
                className="cursor-pointer underline-offset-2 transition-colors hover:text-[var(--qw-fg)] hover:underline"
              >
                {segment}
              </button>
            ) : (
