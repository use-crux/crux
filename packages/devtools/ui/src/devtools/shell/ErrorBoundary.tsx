...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    ...
    console.error("[DevtoolsShell] Screen crashed:", error, info);
  }
  ...
  render() {
    ...
    return (
      <div
        ...
        style={{ background: "var(--devtools-bg)", color: "var(--devtools-fg)" }}
      >
        <div
        ...
        >
          ...
          >
            This screen could not render. The rest of Devtools is still
            functional.
          </p>
          <pre
