  ...
  return (
    <div
      ...
      style={{
        ...
        border: "1px dashed var(--devtools-danger)",
        color: "var(--devtools-fg)",
      }}
    >
      <div className="min-w-0 flex-1">
        <div className="font-semibold" style={{ color: "var(--devtools-danger)" }}>
          {title}
        </div>
        <div
...
> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    ...
    console.error(
      `[Section "${this.props.title ?? "unknown"}" crashed]`,
      error,
      info,
    );
  }
      ...
      renderFallback={({ error, reset }) => (
        ...
        >
          <span
            ...
            style={{ background: "var(--devtools-danger)" }}
          />
 ...
 *   <SectionBoundary
 *     title="Run detail"
 *     invalidateKeys={[qk.inspect.run(traceId)]}
