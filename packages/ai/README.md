...
AI SDK helpers (`tool`, `stepCountIs`, `hasToolCall`) are not re-exported — import them from `'ai'`. Agent compositions come from `@use-crux/core/agent`.
