...
const storageFactoryByCallName: Readonly<Record<string, SemanticStorageFactoryDescriptor | undefined>> = {
...
export const semanticStorageCallNames = Object.keys(storageFactoryByCallName).sort()
...
export function hasSemanticStorageBundleFields(fields: ReadonlySet<string>): boolean {
  return fields.has('records') || fields.has('vectors') || fields.has('blobs')
}
