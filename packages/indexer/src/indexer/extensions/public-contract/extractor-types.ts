...
export interface ExtractContext {
   ...
   *
   * Use this for positional APIs such as `collection('name', ...)`. Methods return literal/JSON-like values
 ...
 * are for folded children that belong to the same extracted unit, such as collection items or routing
...
export interface ExtractedDefinition {
   ...
   *
   * Use this for authored children discovered inside the same source expression, such as collection items,
