 ...
 */
export const STATIC_PARSE_CACHE_EPOCH = "static-parse-v90";
/**
 * Semantic v47 adds authored Session identity and Agent target evidence.
 */
export const SEMANTIC_FACTS_CACHE_EPOCH = "semantic-facts-v47";
