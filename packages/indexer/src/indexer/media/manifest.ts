import type { MediaOperationAuthoredOptions, MediaOperationFacts } from '@use-crux/core/project-index'
...
export const authoredMediaPrimitiveManifest = Object.freeze({
  ...
  definitions: Object.freeze([
    ...
    Object.freeze({
      ...
      identity: 'binding-or-callsite',
      fields: Object.freeze(['sourceKind', 'mediaKinds', 'namespace', 'attribution']),
