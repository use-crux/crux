 ...
 *
 * Scorer metadata is projected into index-friendly configuration facts so consumers can understand
 * scoring method/model/thresholds without executing the scorer.
 */
export const scorerIndexExtractor: IndexExtractor = {
  name: 'scorer',
 ...
 *
 * Empty fields are omitted so equivalent authored configs produce stable index metadata without
