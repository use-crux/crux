...
export function flowStepRelationType(kind: ProjectDefinitionKind): string | undefined {
...
export function compositionRelationType(kind: ProjectDefinitionKind): string | undefined {
