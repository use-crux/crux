...
import type { NativeDirectStaticIdArrayDependencySpec } from './manifest'
import { propertyInitializer } from './object'
import { nativeNodeList, nativeSourceForNode } from '../tsgo/source'
import type { NativeDefinition, RelationFact } from './types'
