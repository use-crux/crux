import { semanticEvidenceBatchesFromFacts } from '../evidence'
import { semanticIndexEvidenceBatchesForSourceFiles } from '../facts'
import { measureSemanticTiming } from '../instrumentation'
import { createTsgoSemanticCompilerHost, type TsgoSemanticCompilerHost } from '../tsgo-compiler-session'
