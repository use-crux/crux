...
>(node: TNode, syntax: SemanticSyntaxView<TNode, TSourceFile>): SourceLocation {
  const sourceFile = syntax.sourceFile(node)
  const position = lineAndColumn(sourceFile.text, semanticNodeStart(sourceFile.text, node))
...
>(node: TNode, syntax: SemanticSyntaxView<TNode, TSourceFile>): SourceSnippet {
  ...
  const start = lineAndColumn(sourceFile.text, semanticNodeStart(sourceFile.text, node))
...
export function semanticNodeName<
  TNode extends SemanticSyntaxNode,
  TSourceFile extends TNode & SemanticSyntaxSourceFile<TNode>,
>(node: TNode, syntax: SemanticSyntaxView<TNode, TSourceFile>): string | undefined {
  return syntax.identifierText(node) ?? syntax.stringLiteralText(node) ?? syntax.numericLiteralText(node)
}
...
export function semanticPropertyName<
  TNode extends SemanticSyntaxNode,
  TSourceFile extends TNode & SemanticSyntaxSourceFile<TNode>,
>(property: TNode, syntax: SemanticSyntaxView<TNode, TSourceFile>): string | undefined {
...
export function semanticPropertyInitializer<
  TNode extends SemanticSyntaxNode,
  TSourceFile extends TNode & SemanticSyntaxSourceFile<TNode>,
>(object: TNode, name: string, syntax: SemanticSyntaxView<TNode, TSourceFile>): TNode | undefined {
  const property = syntax.objectProperties(object).find((item) => semanticPropertyName(item, syntax) === name)
...
export function semanticStringLiteralProperty<
  TNode extends SemanticSyntaxNode,
  TSourceFile extends TNode & SemanticSyntaxSourceFile<TNode>,
>(object: TNode, name: string, syntax: SemanticSyntaxView<TNode, TSourceFile>): string | undefined {
  const initializer = semanticPropertyInitializer(object, name, syntax)
  return initializer ? syntax.stringLiteralText(syntax.unwrapExpression(initializer)) : undefined
}
...
>(expression: TNode, syntax: SemanticSyntaxView<TNode, TSourceFile>): boolean {
  ...
  return syntax.isKind(unwrapped, 'identifier') || syntax.isKind(unwrapped, 'propertyAccessExpression')
}
...
>(node: TNode, syntax: SemanticSyntaxView<TNode, TSourceFile>): string | undefined {
  ...
  if (syntax.isKind(parent, 'propertyAssignment') || syntax.isKind(parent, 'shorthandPropertyAssignment')) {
