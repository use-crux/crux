import type { IndexExtractor, ExtractContext, ExtractedFacts, IndexerExtension } from '../public-contract/types'
import type { StaticCallContext } from '../../extractors/types'
import { createExtensionRegistry, type ExtensionRegistry } from '../runtime/registry'
import {
