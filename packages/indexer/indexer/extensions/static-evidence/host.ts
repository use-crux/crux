...
import { loadIndexerExtensionReferences } from '../loading/references'
import {
...
import type { ExtensionIdentity, IndexDependency, IndexerExtension, IndexerExtensionConfig } from '../public-contract/types'
