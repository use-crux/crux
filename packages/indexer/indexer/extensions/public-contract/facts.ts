...
/**
 * Returns a successful extractor result containing immutable index facts.
 *
 ...
 * collections. Resolver, rule, and emitter stages decide how those values become index relations,
 ...
 * specific source shape is not index-relevant. This keeps extractors total and predictable, which is
