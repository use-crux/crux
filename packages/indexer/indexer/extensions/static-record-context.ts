...
import { createStaticRecordSyntaxHandle } from './internal-native'
import { createStaticRecordSourceRefBuilder } from './static-record-source-ref'
import type { ExtractContext, IndexExtractor, IndexerExtension } from './types'
