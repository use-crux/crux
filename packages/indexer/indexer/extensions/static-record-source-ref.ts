...
import type { ExtractedSourceRef, SourceRefBuilder } from './types'
import type {
...
} from './static-record-source-resolver'
import { schemaPropertySourceRefs } from './static-record-schema-source-ref'
