...
/** Files selected for native parsing and the helper-only records they need for parity. */
export interface StaticSyntaxPlanFileSelection {
  ...
  /** Primary and support files, sorted and deduped for deterministic native hosts. */
 ...
 *
 * Native syntax records are also the source-ref lookup table for record-backed
