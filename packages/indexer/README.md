...
The Go runtime in `@use-crux/local` calls this through bounded Node worker bundles embedded by `@use-crux/devtools`. `@use-crux/core` owns the public index contracts; this package owns how local projects are indexed into those contracts.
