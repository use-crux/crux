...
`semantic-facts-v39` hard migration, which includes bounded media streaming,
PromptText fragment-join, diagnostic, and multiline-string refactor evidence,
and authored execution-evidence projection.
