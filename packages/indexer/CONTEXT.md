...
`semantic-facts-v45` hard migration, which includes bounded media streaming,
...
PromptText identities nested inside callback expressions, and typed mixed
