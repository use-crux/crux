...
`semantic-facts-v42` hard migration, which includes bounded media streaming,
PromptText fragment-join, diagnostic, and multiline-string refactor evidence,
authored execution-evidence projection, and context-planning structure.
