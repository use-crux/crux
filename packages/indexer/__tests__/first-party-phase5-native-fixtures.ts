...
describe('first-party Phase 5 native fixtures', () => {
  itWithRustOxc('emits exact native workspace facts from Rust/Oxc records', async () => {
    const source = [
  ...
  itWithRustOxc('matches workspace tool-only intelligence metadata', async () => {
    const source = [
      "const searchDocs = createTool({ name: 'searchDocs' })",
      '',
  ...
  itWithRustOxc('matches property-access workspace calls without config objects', async () => {
    const source = [
  ...
  itWithRustOxc('emits exact native safety facts from Rust/Oxc records', async () => {
    const source = [
  ...
  itWithRustOxc('emits exact native scorer facts from Rust/Oxc records', async () => {
  ...
  itWithRustOxc('emits exact native RAG retriever and pipeline facts from Rust/Oxc records', async () => {
    const source = [
  ...
  itWithRustOxc('emits exact native registry and registry skill facts from Rust/Oxc records', async () => {
    const source = [
  ...
  itWithRustOxc('emits exact native eval facts from Rust/Oxc records', async () => {
    const source = [
