...
export const architectureBaselineRequiredTokens = [
  'packages/indexer/contracts/worker-events',
  'packages/indexer/contracts/static-syntax',
  'packages/indexer/contracts/static-index',
  'packages/indexer/contracts/semantic',
