...
describe('first-party Phase 7 flow native fixtures', () => {
  itWithRustOxc('emits exact native flow facts from Rust/Oxc records', async () => {
    const source = [
  ...
  itWithRustOxc('emits exact native positional flow facts from Rust/Oxc records', async () => {
    const source = [
