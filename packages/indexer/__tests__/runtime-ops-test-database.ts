...
export async function dropPostgresSchemas(
...
export async function closeRuntimeOpsPools(): Promise<void> {
  const globalPools = globalThis as typeof globalThis & {
    __cruxRuntimeOpsPools?: Array<{ end(): Promise<void> }>
  }
  const pools = globalPools.__cruxRuntimeOpsPools ?? []
