  ...
  [
    ...
    },
    {
      ...
      files: {
        ...
        const writer = indexer({ id: 'writer', namespace: 'shared', records, storage: search, dense: text })
        export const sparseWriter = indexer({ id: 'sparse-writer', namespace: 'sparse', records, storage: search, sparse })
        const dynamicWriter = indexer({ id: 'dynamic-writer', namespace: 'dynamic', records, storage: search, dense: dynamicDense })
        export const reader = retriever({ id: 'reader', namespace: 'shared', records, storage: search, dense: vision })
        export const kb = knowledgeBase({ id: 'kb', records, storage: search, embeddings: vision, sparseEmbeddings: sparse })
        export const providerKb = knowledgeBase({ id: 'provider-kb', records, storage: search, embeddings: googleDense, sparseEmbeddings: dynamicSparse })
