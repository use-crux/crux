...
use crate::native_static_relation_policy::NativeStaticRelationPolicy;
...
fn relation_identity_and_merge_match_project_index_contract() {
    ...
    first.source = Some(crate::native_static_facts::NativeStaticSourceLocation {
    ...
    second.source = Some(crate::native_static_facts::NativeStaticSourceLocation {
