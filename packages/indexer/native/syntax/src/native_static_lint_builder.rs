...
//!
//! Built-in rule metadata stays in `native_static_builtin_rule_descriptors.json`
...
pub(crate) fn builtin_rule_descriptors() -> Vec<NativeStaticRuleDescriptor> {
    serde_json::from_str(include_str!("native_static_builtin_rule_descriptors.json"))
