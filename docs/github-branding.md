...
GitHub currently requires these image uploads through the web settings UI.

1. Organization avatar:
   - Open `https://github.com/organizations/use-crux/settings/profile`
   - Upload `assets/crux-org-avatar.png`
