...
CRUX_STATIC_INDEX_WORKER="$PWD/target/debug/crux-indexer-worker" pnpm --filter @use-crux/local-workers parity:indexer-static -- --root="$PWD" --concurrency=8 --max-mismatches=20
