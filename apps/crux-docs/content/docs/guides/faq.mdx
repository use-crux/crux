...
<Cards>
  <Card title="Core Concepts" description="Contexts, prompts, and adapters — the three building blocks." href="/docs/foundations/mental-model" />
  <Card title="Type System" description="Input merging, return types, and introspection API." href="/docs/guides/advanced/type-system" />
  <Card title="Devtools" description="Visual tracing UI for debugging generations and memory." href="/docs/guides/observability/devtools" />
  <Card title="Error Reference" description="Every error Crux can throw, with causes and solutions." href="/docs/guides/advanced/errors" />
</Cards>
