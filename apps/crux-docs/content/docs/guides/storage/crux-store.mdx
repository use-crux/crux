...
Use `cruxConvexStore()` when your app already runs on Convex. See the [Convex guide](/docs/guides/convex) for setup and boundary rules.
...
- `createConvexTransport()` when using Convex.
