...
<Cards>
  <Card title="Core Concepts" description="Deep dive into contexts, prompts, and adapters." href="/docs/foundations/mental-model" />
  <Card title="Project Setup" description="Organize prompts, register with config(), and wire up devtools." href="/docs/getting-started" />
