...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab value="pnpm">```bash pnpm add @crux/otel ```</Tab>
  <Tab value="npm">```bash npm install @crux/otel ```</Tab>
  <Tab value="yarn">```bash yarn add @crux/otel ```</Tab>
  <Tab value="bun">```bash bun add @crux/otel ```</Tab>
</Tabs>
