...
- **[Devtools](/docs/guides/observability/devtools)** — visual UI for development. Live trace timeline, prompt catalog, memory operations.
- **[Cost tracking](/docs/guides/observability/cost-tracking)** — per-call spend attribution, reports, and warn/limit budgets.
- **[Telemetry](/docs/guides/observability/telemetry)** — `@crux/otel` emits OpenTelemetry spans for production (Datadog, Honeycomb, Grafana).
