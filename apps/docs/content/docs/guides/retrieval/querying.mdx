...
A hybrid retriever runs dense-only for media because sparse embeddings are
text-only. Custom retrievers and text-producing recipe steps reject media unless
