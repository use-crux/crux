...
description: Add typed views, evidence-backed relations, assertions, communities, and global search to a knowledge base.
---
...
<Cards>
  <Card title="Knowledge bases" description="Index, reindex, remove, retrieve, scope, and ground a knowledge base." href="/docs/guides/retrieval/knowledge-bases" />
  <Card title="Views" description="Create typed live and pinned read surfaces from metadata." href="/docs/guides/retrieval/views" />
  <Card title="Relations" description="Publish a graph and expand retrieval through it." href="/docs/guides/retrieval/relations" />
  <Card title="Assertions" description="Author evidence-backed propositions and resolve conflicts." href="/docs/guides/retrieval/assertions" />
  <Card title="Communities" description="Prepare and read topic reports over the visible graph." href="/docs/guides/retrieval/communities" />
  <Card title="Global search" description="Search community reports and return cited finding hits." href="/docs/guides/retrieval/global-search" />
</Cards>
