...
<Cards>
  <Card
    title="Querying"
    description="Create retrievers that can be grounded."
    href="/docs/guides/retrieval/querying"
  />
  <Card
    title="Recipes"
    description="Improve evidence selection before citation validation."
    href="/docs/guides/retrieval/recipes"
  />
  <Card
    title="Citations Reference"
    description="Full `grounding()` and citation API."
