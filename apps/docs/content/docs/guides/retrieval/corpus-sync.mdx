...
Add a `sparse` embedding to the indexer when your retriever runs sparse or fused search. See [Embeddings](/docs/guides/retrieval/embeddings) for defining both.
