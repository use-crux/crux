...
| `allowed-tools`, `model`, `argument-hint`, `user-invocable` | n/a      | no           | Claude Code / IDE-specific fields; safely ignored                                    |
...
**Optimize the description for routing, not marketing.** The model loads a skill based on the index description alone. Make it answer the question _"what kind of task would I use this for?"_ in one line.
