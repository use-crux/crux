...
const tone = skill.inline({
  ...
  instructions:
    "Always write in a warm professional tone. Avoid jargon unless the user uses it first.",
});
...
const research = skill.fromRegistry(
  skillsSh,
  "mattpocock/skills/research-synthesis",
);
...
const reviewer = agent({
  prompt: prompt({
    ...
    use: [
      ...
      seo,
      research,
      context({ id: "base", system: "You review marketing content." }),
    ],
    system: "",
  }),
});
