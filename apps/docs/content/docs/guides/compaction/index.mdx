...
- **[Token budget](/docs/guides/contexts/token-budget)** drops *contexts* under pressure. Compaction shortens *messages*. They compose: budget tracking can include both.
- **[Memory](/docs/guides/memory)** stores entries permanently. Compaction operates on the message history fed to a single LLM call.
- **[Eval](/docs/guides/quality)** can score compaction quality with `evaluateCompaction()` and pre-built judges.

## Pick a topic

<Cards>
  <Card title="Sliding window" description="Stateful auto-rolling compression for chat." href="/docs/guides/compaction/sliding-window" />
  <Card title="Budget manager" description="Measure token pressure, react with your own strategy." href="/docs/guides/compaction/budget" />
  <Card title="Summarize messages" description="One-shot stateless summarization." href="/docs/guides/compaction/summarization" />
  <Card title="Extract key facts" description="Typed structured extraction with Zod schemas." href="/docs/guides/compaction/extraction" />
</Cards>
