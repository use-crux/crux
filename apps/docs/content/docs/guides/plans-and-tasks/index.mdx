...
<Cards>
  <Card
    title="Plans"
    description="Persistent intent documents and plan handles."
    href="/docs/guides/plans-and-tasks/plans"
  />
  <Card
    title="Tasks"
    description="Dynamic and typed task ledgers."
    href="/docs/guides/plans-and-tasks/tasks"
  />
  <Card
    title="Workers"
    description="Task-scoped contexts and tools."
    href="/docs/guides/plans-and-tasks/workers"
  />
  <Card
    title="Reactive UI"
    description="React hooks and transports."
