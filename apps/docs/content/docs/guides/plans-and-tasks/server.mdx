...
Plans and task ledgers persist through the configured `RecordStore`. Server code should pass IDs across process boundaries and rebind handles where work runs.
