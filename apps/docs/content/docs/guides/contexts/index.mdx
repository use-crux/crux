...
<Cards>
  <Card
    title="Caching"
    description="Cache expensive context resolvers and use Anthropic prompt caching."
    href="/docs/guides/contexts/caching"
  />
  <Card
    title="Token budget"
    description="Set a budget and let Crux drop lowest-priority contexts under pressure."
    href="/docs/guides/contexts/token-budget"
  />
  <Card
    title="API Reference"
    description="Full context() signature, when(), match(), and helpers."
