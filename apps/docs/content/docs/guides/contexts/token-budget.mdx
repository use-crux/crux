...
<Callout type="info">
Use `.inspect()` to see exactly which contexts were kept, dropped, and why — see [Type System](/docs/guides/advanced/type-system) for the full inspection API.
</Callout>
...
<Cards>
  <Card title="Middleware & Hooks" description="Global middleware and per-prompt lifecycle hooks for observability." href="/docs/guides/observability/middleware" />
  <Card title="Compaction" description="Tools for keeping long conversations within token limits." href="/docs/guides/compaction" />
  ...
  <Card title="API Reference" description="Full compaction and budget manager API signatures." href="/docs/reference/crux-core/compaction" />
</Cards>
