...
- Object-bound [flows](/docs/guides/flows): `flow.suspend()`, `flow.signal()`, and `flow.run({ resume })` work when your code still holds the flow handle and resumes it explicitly.
