...
Flows are the orchestration layer. [Blackboard](/docs/guides/agents/blackboard), [Handoff](/docs/guides/agents/tools-and-handoffs), and [Delegate](/docs/guides/agents/delegate) are the building blocks that plug into steps. Used inside a flow, they give you validated data transfer between agents, callable sub-pipelines, and shared typed state across steps — all with the same retry, fallback, and tracing the rest of the flow gets.
...
- [Handoff](/docs/guides/agents/tools-and-handoffs), [Delegate](/docs/guides/agents/delegate), [Blackboard](/docs/guides/agents/blackboard) — full guides per primitive
