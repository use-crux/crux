...
<Cards>
  ...
  <Card title="Token Management" description="Token-aware rendering and automatic context dropping." href="/docs/guides/contexts/token-budget" />
  <Card title="Security" description="Input sanitization and prompt injection defense." href="/docs/guides/safety/security" />
</Cards>
