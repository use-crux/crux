...
Crux builds the **Catalog** underneath. Most users only need Catalog, Runs,
Eval, and the combined Health presentation; the raw Project Index compiler
contract is advanced reference material.

## What Crux Checks

Crux checks authored definitions such as prompts, contexts, tools, agents, flows, memory, workspaces, Evals, guardrails, routing primitives, and compositions.
