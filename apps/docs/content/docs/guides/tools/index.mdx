...
import { generate, tool, stepCountIs } from '@use-crux/ai'
...
```ts
import { generate, tool, stepCountIs, hasToolCall } from '@use-crux/ai'
...
<Cards>
  ...
  <Card title="API Reference" description="Full @use-crux/core API — prompt tools, toolChoice, and stopWhen." href="/docs/reference/crux-core" />
</Cards>
