...
| `use` | Reusable capabilities: [contexts](/docs/guides/contexts), [memory](/docs/guides/memory), [retrieval](/docs/guides/retrieval), [grounding](/docs/guides/retrieval/grounding), [blackboards](/docs/guides/agents/blackboard), [skills](/docs/guides/skills), and [custom injectables](/docs/reference/crux-core/prompts#custom-injectable-entries) |
...
Every entry in `use` is injectable in the product sense: it can add instructions, tools, constraints, metadata, or lifecycle behavior during prompt resolution. Some entries use the generic [`injectable()`](/docs/reference/crux-core/prompts#custom-injectable-entries) API; others, such as [skills](/docs/guides/skills), [memory](/docs/guides/memory), [blackboards](/docs/guides/agents/blackboard), [retrieval](/docs/guides/retrieval), and [grounding](/docs/guides/retrieval/grounding), have dedicated first-class APIs.
...
const chatReply = prompt({
  ...
  system: 'Answer as a careful assistant.',
  messages: ({ input }) => [
...
| Retrieve documents as evidence | [`retriever()`](/docs/guides/retrieval/querying), [`retrievalPipeline()`](/docs/guides/retrieval/pipelines), or [`grounding()`](/docs/guides/retrieval/grounding) in `use` |
