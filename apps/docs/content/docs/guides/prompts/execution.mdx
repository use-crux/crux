...
the focused [SDK Bridges guide](/docs/guides/prompts/sdk-bridges). Normal Prompt
...
<Cards>
  ...
  <Card
    title="SDK Bridges"
    description="Convert messages and supply generation to framework-neutral Core APIs."
    href="/docs/guides/prompts/sdk-bridges"
  />
  <Card
    title="Examples"
