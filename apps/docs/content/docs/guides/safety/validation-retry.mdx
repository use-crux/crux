...
[optional and nullable fields](/docs/guides/prompts#optional-and-nullable-fields)),
...
<Callout>
  ...
  `fullStream`, and `partialOutputStream` has cleared every gate that could still
  block or change it.
</Callout>
