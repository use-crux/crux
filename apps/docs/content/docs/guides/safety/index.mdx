...
- **[Quality](/docs/guides/quality)** validates output quality *during testing*. Guardrails and constraints validate it *during execution*. `judgeConstraint()` (`@crux/core/scoring`) bridges the two by enforcing an LLM-judge score as a constraint.
