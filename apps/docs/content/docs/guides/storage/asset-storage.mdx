...
For the lifecycle of model-generated images and audio, including explicit
persistence and authenticated delivery, see
[Media: Storage and delivery](/docs/guides/media/storage-and-delivery).
