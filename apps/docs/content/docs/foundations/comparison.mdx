...
The Vercel AI SDK is an excellent execution and UI toolkit. Crux uses it as a primary adapter via `@use-crux/ai`. The comparison is about what you add when you organize the prompt setup around that execution.
