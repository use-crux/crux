...
| `@use-crux/convex`    | Convex RecordStore adapter, dense VectorStore adapter, workspace AssetStore, server boundaries, Agent bridge, and swarm component                            | Your backend is Convex                                 |
