...
You might start with a typed prompt. Later you add shared context. Then memory. Then retrieval. Then Evals. Each piece should be useful on its own, and each piece should still fit with the others when your system grows.
...
<Cards>
  ...
  <Card
    title="Comparison"
    description="Understand where Crux fits next to SDKs, frameworks, tracing, and eval tools."
