...
<Cards>
  <Card title="Project Setup" description="Organize prompts into trees with createPrompts() and config()." href="/docs/guides/prompts" />
  <Card title="Contexts" description="Make your prompts share brand voice, terminology, and tools." href="/docs/guides/contexts" />
  <Card title="Memory" description="Add chat history, agent state, or semantic recall." href="/docs/guides/memory" />
  <Card title="Devtools" description="Wire up the visual tracing UI for development." href="/docs/guides/observability/devtools" />
</Cards>
