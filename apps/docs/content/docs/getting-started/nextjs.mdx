...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">
```bash
npm install @crux/core @crux/ai @ai-sdk/openai zod
```
  </Tab>
  <Tab value="pnpm">
```bash
pnpm add @crux/core @crux/ai @ai-sdk/openai zod
```
  </Tab>
  <Tab value="yarn">
```bash
yarn add @crux/core @crux/ai @ai-sdk/openai zod
```
  </Tab>
  <Tab value="bun">
```bash
bun add @crux/core @crux/ai @ai-sdk/openai zod
```
  </Tab>
</Tabs>
{/* prettier-ignore-end */}
