...
Use `createConvexRuntimeBridge()` when custom actions or normal Convex Agent-shaped code need the Crux runtime/storage/bridge without the profile-backed agent helper.
