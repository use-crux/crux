...
<Callout type="info">
  **Why server-side?** Crux prompts compose contexts, manage memory, and call
  provider APIs, all of which require server-side credentials and persistent
  storage. The mobile app sends inputs and receives outputs.
</Callout>
...
export default function App() {
  return (
    <CruxProvider transport={transport}>{/* your screens */}</CruxProvider>
  );
}
```
...
<Cards>
  ...
  <Card
    ...
    description="Use Convex actions as your Expo backend."
