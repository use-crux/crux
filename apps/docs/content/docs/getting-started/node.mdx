...
If you'd rather call the OpenAI SDK directly (no Vercel AI SDK), use `@use-crux/openai`:
...
<Cards>
  ...
  />
  <Card title="Quality" description="Test prompts, flows, agents, and functions from discovered eval files." href="/docs/guides/quality" />
