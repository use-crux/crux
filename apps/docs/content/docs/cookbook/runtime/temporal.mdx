...
export const chargeCustomer = task('charge-customer', {
...
The activity resolves a Crux runtime task target by durable target name. A real adapter should use generated artifacts rather than a hand-written map.
