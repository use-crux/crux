...
import { approvalMiddleware } from "@use-crux/core/tool-middleware";
import { toolApprovalResponse } from "@use-crux/core/adapter/tool";
...
const answer = await rl.question(
  `Approve ${request.toolCall.toolName}? [y/N] `,
);
rl.close();
