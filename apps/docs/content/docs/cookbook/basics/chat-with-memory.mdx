...
description: Compose planned history, working state, episodes, and proposed facts for a practical chat agent.
---
...
const chatPrompt = prompt({
  id: "chat",
  use: [history.recent({ messages: 12 }), assistantMemory],
  input: chatInput,
