...
`records` keeps file metadata and small inline text. `assets` keeps binary and large files. See [Storage](/docs/guides/storage) and [AssetStore](/docs/guides/storage/asset-storage) for custom S3/R2/GCS-style asset stores.
