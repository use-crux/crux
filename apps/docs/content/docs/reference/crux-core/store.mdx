...
Use [`@use-crux/core/storage`](/docs/reference/crux-core/storage) for new application code. It exposes the canonical `RecordStore`, `VectorStore`, and `BlobStore` interfaces.
