...
<Cards>
  ...
  <Card
    title="Storage"
    description="RecordStore, VectorStore, AssetStore, and storage bundles."
...
| `storage`                     | `Storage`                  | Standard records, vectors, and assets bundle used by durable primitives.             |
...
never persisted in records or vector metadata. The namespace's dense embedding
...
- Reference: [Storage](/docs/reference/storage), persistent RecordStore, VectorStore, and AssetStore implementations
