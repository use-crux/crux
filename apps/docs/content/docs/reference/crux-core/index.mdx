...
<Cards>
  ...
  <Card
    ...
    description="defineProviderRuntime, ownership models, adapter IR, and conformance harnesses."
...
import { adapter, executorAdapter, defineProviderRuntime } from '@use-crux/core/adapter'
...
import { plan, getPlan, updatePlan, planAgent, createPlanTool } from '@use-crux/core/plan'
import { tasklist, taskListAgent, taskWorker, createTaskListTool } from '@use-crux/core/tasks'
