...
Indexer extensions, experimental indexer flags, persistence, generation hooks, devtools,
...
| `persistence.records`         | `RecordStore`              | Explicit runtime persistence for flows, plans, and bridge reads.                     |
