...
The public subject union reserves an `effect.receipt` shape for the Effects
API. Receipt construction, graph resolution, recovery, and rollback are not
part of this Core release; unresolved receipt refs are rejected.
