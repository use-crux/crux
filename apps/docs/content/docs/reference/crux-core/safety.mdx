...
| Helper                             | Boundary                                                                        |
| ---------------------------------- | ------------------------------------------------------------------------------- |
| `boundary.input.text()`            | Untrusted user, tool, and rendered retrieval text immediately before the model. |
...
Text supports `user`, `tool`, and `retrieval`; media supports `user` and `tool`.
