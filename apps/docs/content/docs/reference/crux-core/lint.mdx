...
Preview rules remain available through their configured profiles, but their policy wording, suppression guidance, or backend evidence may still change before the stable rule set adopts them.
