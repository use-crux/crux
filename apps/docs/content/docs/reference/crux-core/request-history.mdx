...
When a Thread owns the canonical transcript, the same policies project its
selected path without changing stored history. See
[Managed conversations](/docs/guides/threads/conversations#history-planning-and-thread-revisions).
...
- Guide: [Managed Thread conversations](/docs/guides/threads/conversations)
