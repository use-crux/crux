...
For quality runs, `scorers.judge()` in [`@use-crux/core/quality`](/docs/reference/crux-core/quality) reuses this judge machinery with rubric and choice-score modes.
