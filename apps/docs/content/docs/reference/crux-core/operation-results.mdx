...
- `JudgeResult` and `CitationValidationResult`;
...
| Judge, citations, content indexing summaries                                            | Included: exact owning-operation pair                                                             |
...
| Convex upstream Agent aliases, swarm durable state, and turn results                    | Excluded                                                                                           |
