...
| `use`         | `ContextEntry[]?`                                  | Nested entries resolved before this context's own system text. Supports [`context()`](/docs/reference/crux-core/contexts), [`when()`](/docs/reference/crux-core/contexts), [`match()`](/docs/reference/crux-core/contexts), [skills](/docs/reference/crux-core/skill), [memory](/docs/reference/crux-core/memory), [blackboards](/docs/reference/crux-core/agent), [retrievers and grounding](/docs/reference/crux-core/retrieval), and [custom contributor entries](/docs/reference/crux-core/prompt-resolution#custom-contributor-entries). |
