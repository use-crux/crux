...
Excluded conditional Contexts contribute nothing. Representation changes retain
the contributor's owned capabilities unless an explicitly droppable
contributor is omitted.
