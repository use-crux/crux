...
Generation and stream spans project Crux graph metrics into GenAI attributes: `gen_ai.client.operation.duration`, `gen_ai.server.time_to_first_token`, `gen_ai.client.output_tokens_per_second`, and `gen_ai.client.time_per_output_chunk_ms`.
