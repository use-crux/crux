...
Google package still owns the SDK request shape, function-call normalization, response metadata normalization, and
CachedContent manager; the shared core profile only supplies the adapter shell, structured/text helper plumbing, and
