...
| `options.model`           | `LanguageModel \| FallbackModel<LanguageModel> \| AnyRouterModel<LanguageModel> \| CascadeModel<LanguageModel>` | AI SDK model or a [`fallback()`](/docs/guides/advanced/fallback), [`router()`](/docs/guides/advanced/routing), or [`cascade()`](/docs/guides/advanced/routing) wrapper |
...
| ------------------------ | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `prompt`                 | `Prompt`                                                                         | The prompt to execute                                                                                                |
| `options.model`          | `LanguageModel \| FallbackModel<LanguageModel> \| AnyRouterModel<LanguageModel>` | AI SDK model or [`fallback()`](/docs/guides/advanced/fallback) / [`router()`](/docs/guides/advanced/routing) wrapper |
| `options.input`          | `MergedInput<TOwnInput, TContexts>`                                              | Input values — merged across the prompt's own schema and every context's `input` schema                              |
| `options.tools`          | `ToolSet?`                                                                       | Additional tools to merge at call time                                                                               |
| `options.toolMiddleware` | `ToolMiddleware \| readonly ToolMiddleware[]?`                                   | Call-site tool wrappers. See [Tool Middleware](/docs/reference/crux-core/tool-middleware).                           |
| `options.toolChoice`     | `ToolChoice<ToolSet>?`                                                           | Tool choice strategy                                                                                                 |
