...
| ----------------------------------------------------------------------------------------- | ------------- | --------- | ------------------------------------------------- |
| Exposes text/structured/stream chat calls and leaves tool execution to Crux               | `single-turn` | `turn`    | `@crux/openai`, `@crux/anthropic`, `@crux/google` |
| Runs its own multi-step tool loop (`generateText` with `stopWhen`, native tool execution) | `loop-owned`  | `loop`    | `@crux/ai`                                        |
