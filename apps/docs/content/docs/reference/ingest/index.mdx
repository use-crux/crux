...
type IngestPart =
  ...
  | { kind: 'page'; id: string; pageNumber: number; content: string; sourceLocation?: { type: 'page'; pageNumber: number } }
...
interface IngestDocument {
  namespace: string
  sourceId: string
  source?: { url?: string; path?: string; assetRef?: AssetRef; mediaType?: string }
  parts: IngestPart[]
  content: string
  title?: string
...
const media: IngestMediaOperations = {
  ...
  transcribe: ({ audio, abortSignal }) => transcribe({ model: audioModel, audio, abortSignal }),
}
