...
<Callout type="warn">
  This API is experimental. It is production-used by Crux first-party internals and supports explicit allowlisted package
  loading, but it is not a sandboxed third-party plugin ecosystem yet.
</Callout>
