...
Live MCP tasks can affect real systems. Evals should bind the same managed
production task to a deterministic fixture when remote side effects are not
acceptable. The fixture prevents remote
