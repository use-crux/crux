...
The host package exposes Crux-owned worker bridges for static planning/config, semantic enrichment, runtime patching, and Static Index extension-host calls.
It also exports the relation model facade used internally: `resolveRelationModel`,
