...
description: Convex Storage Beta adapters, Convex runtime profile, Convex Agent integration, and flow helpers.
---
...
import { history } from "@use-crux/core/history";
import { tool } from "@use-crux/convex/tools";
import { z } from "zod";
import { components } from "./_generated/api";
...
const supportPrompt = prompt({
  id: "support-agent",
  use: [history.recent({ messages: 10 })],
