...
description: Server-side SSE handler for streaming RecordStore changes to the browser.
---
...
| ---------------- | ----------- | -------------------------------------------------------------------------------------- |
| `options.store`  | `RecordStore` | The RecordStore to subscribe to. Must implement `subscribe()`.                           |
...
| Field    | Type        | Description                                                  |
| -------- | ----------- | ------------------------------------------------------------ |
| `store`  | `RecordStore` | The RecordStore to subscribe to. Must implement `subscribe()`. |
