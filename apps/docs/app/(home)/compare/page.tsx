    ...
    <main>
      ...
      <section className="relative overflow-hidden px-6 pt-28 pb-16 sm:pt-36 sm:pb-20">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <p className="mb-4 text-xs font-medium tracking-[0.2em] uppercase text-crux">Comparisons</p>
          ...
          <p className="mx-auto mt-6 max-w-xl text-[1.05rem] leading-relaxed text-fd-muted-foreground">
            Crux isn&apos;t trying to replace your SDK. It&apos;s a kit of typed building blocks for the harness around
            it. Pick the ones you need, drop the rest.
          </p>
        </div>
      </section>
      ...
      {comparisons.map((c, idx) => (
        ...
        >
          <div className="mx-auto max-w-4xl">
            {/* Header */}
            <div className="mb-10">
              <p className="mb-2 text-xs font-medium tracking-[0.15em] uppercase text-crux">{c.subtitle}</p>
              <h2 className="text-2xl font-[700] tracking-[-0.02em] sm:text-3xl">{c.title}</h2>
              <p className="mt-3 max-w-2xl text-[0.95rem] text-fd-muted-foreground">{c.description}</p>
            </div>
            ...
            <div className="overflow-hidden rounded-xl border border-fd-border">
              ...
              {c.rows.map((row, i) => (
                ...
                >
                  <div className="px-4 py-3.5 text-[13px] font-semibold">{row.label}</div>
            ...
            <div className="mt-6 flex gap-3 rounded-lg border border-crux/15 bg-crux-soft px-5 py-4">
              ...
              <p className="text-[13px] leading-relaxed text-fd-muted-foreground">
                <span className="font-medium text-fd-foreground">Bottom line:</span> {c.verdict}
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="relative border-t border-fd-border px-6 py-16">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-2 text-center">
          <p className="text-[13px] text-fd-muted-foreground">Jump to a comparison:</p>
      ...
      <section className="relative border-t border-fd-border px-6 py-28">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-[700] tracking-[-0.025em]">Try it yourself</h2>
