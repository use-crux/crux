...
const withCode: CodeLine[] = [
  ...
  {
    text: `import { constrain } from '@use-crux/core/constrain'`,
    type: "import",
  },
    ...
    <main>
      ...
      <section className="relative overflow-hidden px-6 pt-28 pb-20 sm:pt-32">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 45% at 50% -10%, var(--crux-glow), transparent)",
          }}
        />
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-7 max-w-xl text-[1.05rem] leading-[1.65] text-fd-muted-foreground">
            When LLM features fail in production, the fix usually isn&apos;t the
            prompt and isn&apos;t the model. It&apos;s a missing memory write, a
            stale retrieval, a guardrail that should&apos;ve blocked the input,
            a router that picked the wrong model, an eval that should&apos;ve
            caught it before ship. That layer is the{" "}
            <span className="text-fd-foreground">harness</span>: everything
            around the model call. Crux is a kit of typed building blocks for
            it. Pick what you need, drop the rest. No runtime to adopt, no
            framework to fight.
          </p>
        </div>
      </section>
            ...
            {evolutionStages.map((s) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="font-mono text-[10px] tracking-[0.22em] font-semibold text-crux">
                    {s.tag}
                  </span>
                  <span className="font-mono text-[10px] tracking-[0.14em] text-fd-muted-foreground/60">
                    {s.meta}
                  </span>
                </div>
                <h3 className="mt-4 text-[22px] font-semibold tracking-[-0.018em]">
                  {s.title}
                </h3>
                <p className="mt-2.5 text-[14px] leading-[1.6] text-fd-muted-foreground">
                  {s.body}
                </p>
              </div>
            ))}
            ...
            <CodePanel
              ...
              headerKicker={
                <span className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-[11px] tracking-[0.1em] text-crux">
                    WITH CRUX · A HARNESS
                  </span>
                </span>
              }
            ...
            {principles.map((p, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-[14.5px] leading-[1.6] text-fd-muted-foreground">
                    {p.body}
                  </p>
                </div>
              </li>
            ...
            {notItems.map((n) => (
              ...
              >
                <div
                  ...
                  style={{ background: "var(--color-fd-background)" }}
                />
                <h3 className="text-[16px] font-semibold tracking-[-0.01em] text-fd-muted-foreground">
                  {n.n}
                </h3>
                <p className="mt-2 text-[13.5px] leading-[1.6] text-fd-muted-foreground/80">
                  {n.body}
                </p>
              </div>
            ))}
      ...
      <section className="relative border-t border-fd-border px-6 py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[16px] leading-[1.65] text-fd-muted-foreground">
            In Next.js, Node.js, or Convex. If you&apos;re managing more than a
            handful of prompts and shipping to users who expect reliable output,
            Crux gives you the structure to manage that complexity without
            adopting a heavyweight framework.
          </p>
      ...
      <section className="relative border-t border-fd-border px-6 py-28">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-[16px] text-fd-muted-foreground">
            One install, one prompt. Add memory, retrieval, guardrails, and
            traces as you need them.
          </p>
