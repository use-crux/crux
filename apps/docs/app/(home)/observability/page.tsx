...
const pluginCode: CodeLine[] = [
  ...
  { text: `      return {`, type: 'code' },
  { text: `        instrumentationHooks: {`, type: 'highlight' },
  { text: `          onJudgeResult: (e) => {`, type: 'code' },
  { text: `            if (e.metric === 'faithfulness' && e.score < 0.7) {`, type: 'code' },
  ...
  { text: `                  text: \`faithfulness drop on \${e.promptId}\`,`, type: 'code' },
  { text: `                }),`, type: 'code' },
  { text: `              }).catch(() => {}) // fire-and-forget`, type: 'code' },
  { text: `            }`, type: 'code' },
  { text: `          },`, type: 'code' },
  { text: `          onMemoryWrite: (e) => {`, type: 'code' },
  { text: `            audit.log({ store: e.store, entries: e.count })`, type: 'code' },
  { text: `          },`, type: 'code' },
  { text: `        },`, type: 'code' },
  { text: `        dispose: () => { /* cleanup */ },`, type: 'code' },
  { text: `      }`, type: 'code' },
  { text: `    },`, type: 'code' },
  { text: `  }`, type: 'code' },
  { text: `}`, type: 'code' },
...
const pluginHooks = [
  {
    k: 'instrumentationHooks',
    v: 'onMemoryRead/Write, onCompactStart/End, onBudgetCheck, onHandoffPrepare, onDelegateStart/Complete, onJudgeResult.',
  },
  {
    k: 'middleware',
